    ...
    function loadAll()
    {
        $.get(
            ...
            function(data){
                ...
                if (obj.status == 42)
                {
                    document.cookie = "total_7days=" + obj.total_7days;
                    document.cookie = "total_new7days=" + obj.total_new7days;
                    document.cookie = "nbUsers=" + obj.nbUsers;
                    document.cookie = "nbAdmins=" + obj.nbAdmins;
                }
            },
