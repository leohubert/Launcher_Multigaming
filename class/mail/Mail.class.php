...
class Mail{
    ...
    public function exeConfig($at, $code){

        $gconf = json_decode($this->getConfig());
        if ($gconf->secure == 'tls') {
            $gconf->secure='PHPMailer::ENCRYPTION_STARTTLS';
        }else{
            $gconf->secure='';
        }
        $gconf->to = $at;
        ...
        try {
            ...
            //Parameters to sender and reply to
            $this->email->setFrom($gconf->sender, 'Support');
            $this->email->addReplyTo($gconf->sender, 'Support');
            $this->email->AddAddress($gconf->to);

            //Mail Content
            $this->email->isHTML(true);
            $this->email->Subject = 'Recover your password';
            #$this->email->Body = $code;
...
<p style="font-size: 24px; line-height: 1.2; text-align: center; word-break: break-word; font-family: lucida sans unicode, lucida grande, sans-serif; mso-line-height-alt: 29px; margin: 0;"><span style="font-size: 24px;">Recover your account !</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<div align="center" class="img-container center autowidth autowidth" style="padding-right: 0px;padding-left: 0px;">
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center autowidth autowidth" src="http://51.77.211.14/assets/images/password.jpg" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 600px; display: block;" title="Image" width="600"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
<!--[if (!mso)&(!IE)]><!-->
</div>
...
<p style="font-size: 16px; line-height: 1.5; text-align: center; font-family: lucida sans unicode, lucida grande, sans-serif; word-break: break-word; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-size: 16px;">Dear ' . $gconf->to . '</span></strong></span></p>
<p style="font-size: 16px; line-height: 1.5; text-align: center; font-family: lucida sans unicode, lucida grande, sans-serif; word-break: break-word; mso-line-height-alt: 24px; margin: 0;"><span mce-data-marked="1" style="font-size: 16px;"><strong><span mce-data-marked="1" style="font-size: 16px;">Here\'s your password!</span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div style="line-height: 1.5; font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; color: #283C4B; mso-line-height-alt: 18px;">
<p style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; font-family: lucida sans unicode, lucida grande, sans-serif; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">You recently asked to change your password from our web page.</span></p>
...
<p style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; font-family: lucida sans unicode, lucida grande, sans-serif; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">Here is your verification code :' . $code . '</span></p>
<p style="font-size: 12px; line-height: 1.5; text-align: center; word-break: break-word; font-family: lucida sans unicode, lucida grande, sans-serif; mso-line-height-alt: 18px; margin: 0;"></p>
<p style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; font-family: lucida sans unicode, lucida grande, sans-serif; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">WARNING : If you are not at the origin of this request please contact our administrative team as soon as possible.</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<div align="center" class="button-container" style="padding-top:25px;padding-right:0px;padding-bottom:0px;padding-left:0px;">
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 25px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="' . $gconf->url . '" style="height:39pt; width:194.25pt; v-text-anchor:middle;" arcsize="8%" stroke="false" fillcolor="#3AAEE0"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:14px"><![endif]--><a href="' . $escaped_url . '/recoveru" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #3AAEE0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width: auto; width: auto; border-top: 1px solid #3AAEE0; border-right: 1px solid #3AAEE0; border-bottom: 1px solid #3AAEE0; border-left: 1px solid #3AAEE0; padding-top: 10px; padding-bottom: 10px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:20px;padding-right:20px;font-size:14px;display:inline-block;"><span style="font-size: 16px; line-height: 2; font-family: lucida sans unicode, lucida grande, sans-serif; word-break: break-word; mso-line-height-alt: 32px;"><span data-mce-style="font-size: 14px; line-height: 28px;" mce-data-marked="1" style="font-size: 14px; line-height: 28px;">CHANGE YOUR PASSWORD</span></span></span></a>
...
<p style="font-size: 14px; line-height: 1.2; text-align: center; font-family: lucida sans unicode, lucida grande, sans-serif; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="font-size: 14px;"><a href="' . $escaped_url . '" style="color: #3AAEE0;" target="_blank" title="' . $escaped_url . '">Or go to our website</a></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<!--[if (IE)]></div><![endif]-->
    ...
    private function getConfig(){
        ...
        $res = array(
            'host' => $this->config->get('host_mail'),
            'username' => $this->config->get('username_mail'),
            'password' => $this->config->get('password_mail'),
            'secure' => $this->config->get('secure_mail'),
            'port' => $this->config->get('ports_mail'),
            'sender' => $this->config->get('sender_mail'),
        );
