...
<div class="wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title"><?php echo L::adminuser_alluserp_title; ?></h4>
            </div>
        </div>
        <!-- Page-Title -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box table-responsive">
                        ...
                        <h4 class="m-t-0 header-title"><b><?php echo L::adminuser_alluserp_title; ?></b></h4>
                        <p class="text-muted font-13 m-b-30">
                        <?php echo L::adminuser_alluserp_subtitle; ?>
                        </p>
