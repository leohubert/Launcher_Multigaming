            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-sm-8 col-lg-8">
                        <div class="widget-simple text-center card-box">
                            ...
                            <p class="text-muted font-500">Total cash</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                ...
                <div class="col-lg-4">
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30">Total Revenue</h4>
                        <div class="widget-chart text-center">
                            <div id="sparkline4"><canvas height="165" width="535" style="display: inline-block; width: 535px; height: 165px; vertical-align: top;"></canvas></div>
                            <ul class="list-inline m-t-15">
                                <li>
                                    <h5 class="text-muted m-t-20">Target</h5>
                                    <h4 class="m-b-0">$1000</h4>
